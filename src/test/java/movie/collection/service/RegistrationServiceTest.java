...
//
//        when(tokenService.getToken(anyString(), TokenType.CONFIRMATION)).thenThrow(TokenNotFoundException.class);
//
...
//        ConfirmationToken confirmationToken = new ConfirmationToken(1L, "random",TokenType.CONFIRMATION ,LocalDateTime.now() ,user );
//
